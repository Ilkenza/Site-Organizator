            ...
            >
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            ...
                            <div>
                                <label className="block text-[10px] sm:text-xs font-semibold text-gray-400 mb-1.5 sm:mb-2">
                                    {(activeTab === 'categories' || activeTab === 'tags') ? 'Sort by Name' : 'Order'}
                                </label>
                ...
                {(activeTab === 'sites' || activeTab === 'favorites') && categories.length > 0 && (
                    <div className="p-3 sm:p-4 flex-1 overflow-y-auto  sm:max-h-none">
                        <h3 className="text-xs font-semibold text-app-text-tertiary uppercase tracking-wider mb-3">
                            Filter by Category
                        </h3>
                ...
                ${!selectedCategory
                  ...
                  ${selectedCategory === cat.id
                        ...
                        {(activeTab === 'sites' || activeTab === 'favorites') && tags.length > 0 && (
                            <>
                                <h3 className="text-xs font-semibold text-app-text-tertiary uppercase tracking-wider mb-3 mt-6">
                                    Filter by Tag
                                </h3>
                                <div className="mb-3 relative">
                                    <input
