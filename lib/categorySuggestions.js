...
const domainPatterns = {
    ...
    // Design & Creative
    'design': ['figma', 'sketch', 'adobe', 'canva', 'dribbble', 'behance', 'unsplash', 'pexels', 'flaticon', 'fontawesome', 'google fonts', 'framer', 'webflow', 'invision', 'whimsical', 'lucidchart', 'procreate', 'affinity', 'pixlr', 'remove.bg', 'photopea', 'spline', 'rive', 'lottiefiles', 'iconify', 'heroicons', 'phosphor', 'lucide', 'tabler', 'feather', 'coolors', 'colorhunt', 'uigradients', 'meshgradient'],
    ...
    // Tools & Utilities
    'tools': ['google', 'translate', 'calendar', 'maps', 'analytics', 'search', 'mail', 'gmail', 'outlook', 'proton', 'grammarly', 'hemingway', 'pastebin', 'jsonlint', 'regex101', 'crontab', 'carbon', 'ray.so', 'excalidraw', 'tldraw', 'squoosh', 'tinypng', 'convertio', 'notion calendar', 'calendly', 'cal.com', 'doodle', 'when2meet', 'shorturl', 'bitly', 'tinyurl', 'rebrandly', 'buffer', 'hootsuite', 'zapier', 'make', 'n8n', 'ifttt'],
 ...
 * @returns {string} The clean domain or empty string
 */
 ...
 * @returns {Set} Set of suggested category names
 */
 ...
 * @returns {Object} Object with categoryIds (array of IDs) and suggestions (array of names)
 */
