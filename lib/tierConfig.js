...
export const TIER_LIMITS = {
    [TIER_FREE]: { sites: 1000, categories: 100, tags: 300, notes: 500, noteGroups: 20, storageItems: 200, courses: 100, aiSuggestsPerMonth: 30 },
    [TIER_PRO]: { sites: 10000, categories: 500, tags: 1000, notes: 5000, noteGroups: 100, storageItems: 2000, courses: 1000, aiSuggestsPerMonth: 500 },
    [TIER_PROMAX]: { sites: Infinity, categories: Infinity, tags: Infinity, notes: Infinity, noteGroups: Infinity, storageItems: Infinity, courses: Infinity, aiSuggestsPerMonth: Infinity },
};
...
export const FEATURE_GATES = {
    ...
    statsInsights: TIER_PRO,   // Expanded stats and insights
    autoOrganize: TIER_PRO,    // Auto-organize using pattern matching
};
